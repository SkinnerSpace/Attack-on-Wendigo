...
namespace Character
{
    public class MovementController : BaseController, IMovementReaderObserver
    {
        ...
        public override void Initialize(PlayerCharacter main) => Initialize(main.OldData, main.Chronos, main.InputReader);
