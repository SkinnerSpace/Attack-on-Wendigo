...
public class MovementInputReader : InputReader
{
    ...
    public void Subscribe(IMovementController movementController)
    {
        onDirectionUpdate += movementController.Move;
    }

    public void Unsubscribe(IMovementController movementController)
    {
        onDirectionUpdate -= movementController.Move;
    }
}
